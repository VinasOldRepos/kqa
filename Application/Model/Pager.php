...
*																					*
* Description: 		This is the Pager's model.										*
*																					*
...
*************************************************************************************/
	...
	Final class Pager {
		...
		public static function pagerOptions($paging_info = false, $this_page = false, $action = false, $type = false) {
			$content				= '';
			if ($paging_info) {
				...
				if ($paging_info['previous']) {
					$content		.= '					<a href="#" class="goto_page" key="'.$paging_info['previous'].'"><img src="/kqa/Application/View/img/arrow_left.gif" width="16" height="16" border="0" /></a>'.PHP_EOL;
				} else {
					$content		.= '					<img src="/kqa/Application/View/img/pixel.gif" width="16" height="16" />'.PHP_EOL;
				}
				$content			.= '					<input size="1" type="text" name="pager_num" id="pager_num" class="pager" value="'.$paging_info['pg_num'].'" /> '.PHP_EOL;
				if ($paging_info['next']) {
					$content		.= '					<a href="#" class="goto_page" key="'.$paging_info['next'].'"><img src="/kqa/Application/View/img/arrow_right.gif" width="16" height="16" border="0" /></a>'.PHP_EOL;
				} else {
					$content		.= '					<img src="/kqa/Application/View/img/pixel.gif" width="10" height="16" />'.PHP_EOL;
				}
				$content			.= '					of<img src="/kqa/Application/View/img/pixel.gif" width="10" height="16" />'.$paging_info['tot_pages'].'<img src="/kqa/Application/View/img/pixel.gif" width="30" height="16" />|<img src="/kqa/Application/View/img/pixel.gif" width="30" height="16" />See'.PHP_EOL;
				...
				if ($paging_info['limit'] != 0) {
					if ($type == 'details') {
						$content	.= '						<option value="10">10&nbsp;</option>'.PHP_EOL;
					} else {
				...
				$content			.= '					per page<img src="/kqa/Application/View/img/pixel.gif" width="30" height="16" />|<img src="/kqa/Application/View/img/pixel.gif" width="30" height="16" />Total: <strong>'.$paging_info['tot_rows'].'</strong> records found'.PHP_EOL;
			}
			return $content;
		}
	}